...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficulty is either: easy , medium ro difficult!'
      }
    },
    ratingsAverage: {
      type: Number,
      default: 4.5,
      min: [1, 'Rating min must be 1'],
      max: [5, 'Rating max must be 5'],
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message: 'A tout discount ({VALUE}) cant bee greater than a price'
      }
    },
    summary: {
      type: String,
